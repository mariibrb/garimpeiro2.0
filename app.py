...
with st.container():
    ...
    with m_col1:
        ...
        <div class="instrucoes-card">
            ...
            <ul>
                <li><b>Digite</b> o CNPJ do cliente na barra lateral e clique em liberar.</li>
                <li><b>Carregue</b> os arquivos XML ou ficheiros ZIP no campo de upload.</li>
                <li><b>Clique</b> no botão "Iniciar Grande Garimpo" para processar os dados.</li>
                <li><b>Suba</b> o relatório Excel de Autenticidade para validar o status real perante a SEFAZ.</li>
            </ul>
        </div>
        """, unsafe_allow_html=True)
    with m_col2:
